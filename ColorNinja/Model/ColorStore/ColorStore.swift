...
class ColorStore {
    ...
    func getPairOfColorRandom(levelOfDifficult: Int) -> (UIColor, UIColor) {
        ...
        let samesameColor = self.generateSameSameColor(rootColot: randomColor, level: levelOfDifficult)
    ...
    private func generateSameSameColor(rootColot: UIColor, level: Int) -> UIColor {
